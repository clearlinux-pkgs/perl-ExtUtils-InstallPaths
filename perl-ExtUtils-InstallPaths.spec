...
cp %{_builddir}/ExtUtils-InstallPaths-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-ExtUtils-InstallPaths/6b12919e33cacff5d00af9cb516b0c915c5daee9 || :
if test -f Makefile.PL; then
